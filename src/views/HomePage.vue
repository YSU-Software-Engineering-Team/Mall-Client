<template>
  <div>
    <header class="home-header wrap" :class="{ active: state.headerScroll }">
      <router-link to="./category" custom v-slot="{ navigate, href, isActive }"
        ><i
          class="nbicon nbmenu2"
          @click="navigate"
          :href="href"
      ...
      <div class="header-search">
        ...
        > -->
        <router-link to="./product-list?from=home" custom v-slot="{ navigate, href, isActive }">
          <span
            class="search-title"
            @click="navigate"
            :href="href"
      ...
      <router-link
        ...
        v-if="!state.isLogin"
        ><span @click="navigate" :href="href" :aria-current="isActive ? 'page' : undefined"
          >登录</span
        >
      </router-link>
      <router-link class="login" to="./user" custom v-slot="{ navigate, href, isActive }" v-else
        ><span @click="navigate" :href="href" :aria-current="isActive ? 'page' : undefined"
          ><van-icon name="manager-o" /></span
      ></router-link>
    </header>
    <nav-bar />
